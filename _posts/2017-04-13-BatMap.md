...
{% endhighlight %}
<sup>Optimizasyonu biraz abarttım, aracı struct'ları (MapPair ve CachePair) sildim, onların yerine direk üretilecek olan int değerleri kullanıyorum. Böylece hem daha ufak bir bellek imzasına sahip oluyoruz hem de performansta %10'a kadar artış görebiliyoruz.</sup>
