...
Dolayısıyla Tuple'ın GetHashCode uygulamasını kullanan bir struct yazarak (MapPair) önemli bir performans artışı sağlayabiliyoruz. Aşağıda Dictionary ve HashCode üreten kodu görebilirsiniz;
{% highlight csharp %}
